...
module.exports = (sequelize, DataTypes) => {
  class Product extends Model {
    ...
    static associate(models) {
      ...
      Product.belongsTo(models.Category, {foreignKey: 'categoryId'}); //:)this field belongs to Product table
      Product.belongsTo(models.Brand, {foreignKey: 'brandId'}); //a P belongs to Br, by {fk}
